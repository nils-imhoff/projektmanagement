...
public class SekretaerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Sekretaer s1 = new Sekretaer("Carina Millow", "1.05", "0711/1849-4517", "0711/1849-4510", "carina.millow@dhbw-stuttgart.de");
        sekretaers.add(s1);
        sekretaers.add(new Sekretaer("Christine Rohne", "1.03", "0711/1849-4513", "0711/1849-4510", "christine.rohne@dhbw-stuttgart.de"));
        sekretaers.add(new Sekretaer("Andrea Dölker", "1.01", "0711/1849-4516", "0711/1849-4510", "andrea.doelker@dhbw-stuttgart.de"));
